/**
  ******************************************************************************
  * @file    STM32F4_SDIO_SD_Driver.h
  * @author  MCD Application Team
  * @version V1.0.0
  * @date    30-September-2011
  * @brief   This file contains all the functions prototypes for the SD Card 
  *          STM32F4_SDIO_SD_Driver driver firmware library.
  ******************************************************************************
  * @attention
  *
...
#ifndef __STM32F4_SDIO_SD_Driver_H
#define __STM32F4_SDIO_SD_Driver_H
...
typedef struct
{
  SD_CSD SD_csd;
  SD_CID SD_cid;
  uint64_t CardCapacity;  //存储卡容量单位字节
  uint32_t CardBlockSize; //块大小
  uint32_t SectorSize; 	  //扇区大小
  uint32_t SectorCount;   //扇区数，扇区数=卡容量/扇区大小
  uint16_t RCA;
  uint8_t  CardType;
} SD_CardInfo;
